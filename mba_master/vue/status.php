...
?>
<link rel="stylesheet" href="css/statusMBA.css">
<?php
...
<section id="Status">
    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
        <div class="titre_inscriptions mt-3 d-flex justify-content-center">
            <h2 class="text-center">Status des étudiants</h2>
        </div>
        <div class="bloc_status mt-3 pl-5">
            <div class="row">
                <div class="col-6 col-sm-6 col-md-2 col-lg-2">
                    <div class="card p-2 mr-5 mt-5 " style="width: 9rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col d-flex justify-content-center">
                                <a href="status_liste.php" class="btn  boutton">Lister</a>
                            </div>
