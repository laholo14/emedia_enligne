...
?>
<link rel="stylesheet" href="css/ajoute_examen.css">
<?php
  ...
  <div class="d-flex" id="content-wrapper">
        <div id="sidebar-container" class="bg-light border-right pt-5">
            ...
            <div class="menu list-group-flush">
                ...
                <a href="#" id="mensuel" class="option list-group-item mt-4 list-group-item-action p-3 border-0"><i class="fas fa-file-alt lead mr-2" style="width: 2px;"></i> Examen Mensuel</a>
        ...
        <div class="w-100 bg overflow-auto" style="height: 800px !important;">
            ...
            <section class="container pt-5">
                <div class="contenu ">
                	...
                	<a href="#" id="mensuele" class="option list-group-item mt-4 list-group-item-action p-3 border-0"><i class="fas fa-file-alt lead mr-2" style="width: 2px;"></i> Examen Mensuel</a>
                <a href="#" id="semestriele" class="option list-group-item mt-3 list-group-item-action p-3 border-0"><i class="fas fa-file-word lead mr-2"></i> Examen Semestriel</a>
                    ...
                    <form method="post" id="formulaire" class="form1" enctype="multipart/form-data">
                        ...
                        <div class="form-group marge">
                            <label for="start" class="titre">Vague:</label><br>
                            <select class="form-control text-center" name="matiere" id="matiere">
...
?>
<script src="js/ajoute_examen.js"></script>
</body>
