...
if (isset($_POST['liste'])) {
    ...
    foreach ($res as $resultat) {
        $table .= '<tr>
                    ...
                    <td align="center"><i class="fa fa-check-circle" data-toggle="modal" data-target=".bd-example-modal-md" aria-hidden="true" onclick="GetIDE('.$resultat['IDETUDIANTS'].')"></i></td>
