...
if (isset($_POST['vague']) and isset($_POST['semestre']) and isset($_POST['numero'])) {
        ...
        if ($count == 1) {
            ...
            $message = '<div style="width: 100%; text-align: center; font-weight: bold">Bonjour...<br>Voici votre Matricule et Mot de passe pour acceder a vos cours</div> <br> <br>
             ...
             <form action="e-media.mg/universite/" method="posts">
              ...
              <tr>
              <br>
              <td>Service Technique: servicetechnique@e-media.mg , 261341841917</td>
              </tr>
              <br>
              <tr>
              <td>Service Finance: servicefinance@e-media.mg , 261344013064</td>
              </tr>
              <br>
              <tr>
              <td>Service Pedagogie LICENCE: universiteenligne.licence@e-media.mg , 261349920407</td>
              </tr>
              <br>
              <tr>
              <td>Service Pedagogie MASTER: universiteenligne.master@e-media.mg, 261344356977</td>
              </tr>
              <br>
              <tr>
    ...
    // Pour les champs $expediteur / $copie / $destinataire, séparer par une virgule s'il y a plusieurs adresses
    $expediteur = 'universiteenligne.licence@e-media.mg';
    //$copie = 'adresse@fai.com';
    //$copie_cachee = 'adresse@fai.com';
    ...
    $etudiants = new Etudiant($db->getCx());
