...
class Connexion
{
	...
	public static function getCxEtudiant()
	{
		...
		try {
			...
			self::$cx2 = new PDO('mysql:host=localhost; dbname=emediam_highschool_mba_master', 'pma', 'e-Emedia?20.');
			//self::$cx2 = new PDO('mysql:host=localhost; dbname=emediam_highschool_mba_master', 'root', '');
