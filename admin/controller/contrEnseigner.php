...
if (isset($_POST['LICENCE']) and isset($_POST['TIC']) and isset($_POST['search'])) {
    ...
    <tr class="">
        ...
        <td>' . $resultat['NOM'] . '</td>
       <td> <button class="btn btn-outline-primary edit" data-toggle="modal" data-target="#Updata" onclick="GetUser('.$resultat['IDMATIERE'].',\''.$resultat['PARCOURS'].'\')"><img src="image/edit.png" width="30px" height="30px" alt=""></button> </td>
